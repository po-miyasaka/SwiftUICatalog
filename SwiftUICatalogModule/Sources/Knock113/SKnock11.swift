...
#warning("arrayにView含めたいけどAnyView使いたくない。")
        ...
        var playingView: some View {
            ...
            let _ = max(0, 1 - (offset / (viewSize.height - toolbarHeight)))
...
#warning("普通にvideoWidthを設定すると隠れているときに文字がつぶれているせいかラベルにだけアニメーションがきかない")
        ...
        @Published var recommendedObjects: [RecommendedType] = [
            ...
            .shorts(
                [
                    ...
                    .init(title: "short2", color: Color.init("gradient01", bundle: nil)),
                    .init(title: "short3", color: .white),
                    .init(title: "short4", color: .green),
                    .init(title: "short5", color: .orange),
                    .init(title: "short6", color: Color.init("gradient03", bundle: nil)),
            ...
            .shorts(
                [
                    ...
                    .init(title: "short12", color: Color.init("gradient01", bundle: nil)),
                    .init(title: "short13", color: .white),
                    .init(title: "short14", color: .green),
                    .init(title: "short15", color: .orange),
                    .init(title: "short16", color: Color.init("gradient03", bundle: nil)),
    ...
    @MainActor
    final class UIMovieView: UIView, @unchecked Sendable {
        ...
        func setupPlayerPeriodicTimeObserver() {
            ...
            Self.player.addPeriodicTimeObserver(forInterval: interval, queue: DispatchQueue.main) { time in
                Task { @MainActor in
                    ...
                    _delegate?.moviePlayer(didUpdatePlaybackTime: timeNow)
                    
                    if let totalDuration = Self.player.currentItem?.duration {
                        let totalSeconds = CMTimeGetSeconds(totalDuration)
                        _delegate?.moviePlayer(didUpdateTotalDuration: totalSeconds)
                    }
                }
            }
        }
